...
export class VendorproductsController {
  ...
  async vendorproductsOfVendor(@Body() req: userDto) {
    try {
      const getproducts =
        await this.vendorproductsService.getvendorproductsofVendor(req);
      return getproducts;
    } catch (error) {
      return {
        statusCode: HttpStatus.INTERNAL_SERVER_ERROR,
  ...
  async getVendorProductById(@Body() req: vendorproductDto) {
    try {
      const getProduct = await this.vendorproductsService.getvendorproductbyid(
        req,
      );
      return getProduct;
    } catch (error) {
  ...
  async addinventManagement(@Body() req: inventoryManagementDto) {
    try {
      const addinvent = await this.vendorproductsService.addInventManagement(
        req,
      );
      return addinvent;
    } catch (error) {
  ...
  async inventoryManagement(@Body() req: inventoryManagementDto) {
    try {
      const inventorymanagement =
        await this.vendorproductsService.inventoryManage(req);
  ...
  async searchProductByPriceandShop(@Body() req: vendorproductDto) {
    try {
      const search =
        await this.vendorproductsService.searchProductsByPriceandShop(req);
      return search;
    } catch (error) {
      return {
        statusCode: HttpStatus.INTERNAL_SERVER_ERROR,
  ...
  async searchByCategory(@Body() req: vendorproductDto) {
    try {
      const search = await this.vendorproductsService.searchProductByCategory(
        req,
      );
      return search;
    } catch (error) {
  ...
  async getProductsByCategory(@Body() req: vendorproductDto) {
    try {
      const getproducts = await this.vendorproductsService.getProductByCategory(
        req,
      );
      return getproducts;
    } catch (error) {
  ...
  async sendProductRequest(@Body() req: productRequestDto) {
    ...
    try {
      const sendRequest = await this.vendorproductsService.sendproductRequest(
        req,
      );
      return sendRequest;
    } catch (error) {
  ...
  async getProductRequestById(
    @Param('productRequestId') productRequestId: string,
  ) {
    try {
      const getRequest = await this.vendorproductsService.getProdRequestById(
        productRequestId,
      );
      return getRequest;
    } catch (error) {
  ...
  async editProductRequest(@Body() req: productRequestDto) {
    req.updatedDate = moment(req.updatedAt).format('DD-MM-YYYY');
    req.updatedTime = moment(req.updatedAt).format('hh:mm:ss');
    console.log(req.date);
    console.log(req.time);
    try {
      const sendRequest = await this.vendorproductsService.editproductRequest(
        req,
      );
      return sendRequest;
    } catch (error) {
  ...
  async productrequestsOfUser(@Body() req: userDto) {
    try {
      const prodRequest =
        await this.vendorproductsService.productRequestsofUser(req);
      return prodRequest;
    } catch (error) {
      return {
        statusCode: HttpStatus.INTERNAL_SERVER_ERROR,
  ...
  async acceptedproductrequests(@Body() req: userDto) {
    try {
      const acceptrequests =
        await this.vendorproductsService.acceptedRequestsOfVendor(req);
